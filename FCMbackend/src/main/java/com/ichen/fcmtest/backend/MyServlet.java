...
package com.ichen.fcmtest.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.ichen.user.fcmtest.backend.MyServlet");
    @Override
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream("/WEB-INF/JaredTest-c8667d8666c4.json"))
                .setDatabaseUrl("https://jaredtest-425bb.firebaseio.com/")
                .build();
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("reminder@jaredtest-425bb.appspotmail.com",
                            "Todo Reminder"));
                    /*msg.setFrom(new InternetAddress("r99521320@gmail.com",
                            "Todo Reminder"));*/
                    msg.addRecipient(Message.RecipientType.TO, new InternetAddress("r99521320@gmail.com", "Recipient"));
